...
Item {
    ...
    Item {
        ...
        PlasmaCore.IconItem {
            ...
            anchors.fill: parent
            colorGroup: normalSource.colorGroup
        }
    }
    ...
    ShaderEffect {
        ...
        readonly property color colorBorder: normalSource.textColor
    ...
    TextShadow {
        ...
        shadowSource: usernameDelegate
        shadowRadius: usernameDelegate.font.pointSize
    }
