...
Item {
    ...
    Item {
        ...
        visible: softwareRendering ? false : true
    ...
    Rectangle {
        ...
        color: softwareRendering ?  PlasmaCore.ColorScope.backgroundColor : "transparent"
    ...
    Rectangle {
        ...
        opacity: mouseArea.containsPress ? .15 : 0
        Behavior on opacity {
            PropertyAnimation {
    ...
    TextShadow {
        shadowSource: label
        shadowRadius: label.font.pointSize
        anchors.fill: label
    }

    PlasmaCore.ColorScope {
        id: complementarySource
    ...
    PlasmaComponents3.Label {
        ...
        color: complementarySource.textColor
