...
Item {
    // property alias cornerRadius: mediaBlurMask.radius
    ...
    // OpacityMask {
    //     source: mediaBlur
    //     maskSource: mediaBlurMask
    //     anchors.fill: mediaBlurMask
    // }
    ...
    RowLayout {
        ...
        anchors.fill: parent
        spacing: 0
// set to 0 so opacity mask will work
        opacity: 0
        ...
        Item {
            ...
            visible: albumArt.status

            FastBlur {
                id: albumArtBlur
                anchors.fill: albumArtSquare
                source: albumArtSquare
// these values need to be tied to pixel ratios
                radius: 40
                visible: true
            ...
            Image {
                ...
                asynchronous: true
// create a cropped square of the art to blur
