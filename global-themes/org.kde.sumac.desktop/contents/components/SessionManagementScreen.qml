...
FocusScope {
    ...
    ColumnLayout {
        ...
        Item {
            height: notificationsLabel.height
            Layout.maximumWidth: PlasmaCore.Units.gridUnit * 16
            Layout.alignment: Qt.AlignHCenter
            Layout.fillWidth: true

            TextShadow {
                shadowSource: notificationsLabel
                shadowRadius: notificationsLabel.font.pointSize
                anchors.fill: notificationsLabel
            }

            PlasmaComponents3.Label {
                id: notificationsLabel
                // make it slightly smaller than username
